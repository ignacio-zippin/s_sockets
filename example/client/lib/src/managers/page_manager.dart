...
import 'package:socket_example_2_client/src/ui/pages/drawing_page.dart';
import 'package:socket_example_2_client/src/ui/pages/message_page.dart';
...
class PageManager {
  ...
  MaterialPageRoute? getRoute(RouteSettings settings) {
    ...
    switch (page) {
      ...
      case PageNames.message:
        return MaterialPageRoute(builder: (context) => MessagePage(arguments));
      case PageNames.drawing:
        return MaterialPageRoute(builder: (context) => DrawingPage(arguments));
      default:
  ...
  goMessagePage({PageArgs? args, Function(PageArgs? args)? actionBack}) {
    _goPage(PageNames.message.toString(), args: args, actionBack: actionBack);
  }

  goDrawingPage({PageArgs? args, Function(PageArgs? args)? actionBack}) {
    _goPage(PageNames.drawing.toString(), args: args, actionBack: actionBack);
  }
}
